...
def init():
    ...
    parser.add_argument('-i', '--inf', metavar = 'File', required = True, \
            help = 'The log_file generated by LongGF .\nNotice that .')
    ...
    parser.add_argument('-sf', metavar = 'File', required = True, \
            help = 'The "gene\tstand_information" file.')
    parser.add_argument('-bam', metavar = 'File', required = False, \
            help = 'Bam file for the sample used by LongGF.')
    parser.add_argument('-gene', metavar = 'File', required = False, \
            help = 'Capture or target gene list, one gene per line.')
    parser.add_argument('-skipc', choices=['Y', 'N'], default='N', required = False, \
            help = 'Wether skip samtools depth count or not, default=N, can be Y if calculated before.')
